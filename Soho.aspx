<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Soho.aspx.vb" Inherits="IlhaPura" %>
                    ...
                    <div id="propertiesDetailsSlider" class="carousel properties-details-sliders slide mb-40">
                        ...
                        <div class="heading-properties-2">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pull-left">
                                        <h3>Soho Residence</h3>
                                        <p><i class="fa fa-map-marker"></i>Av. Embaixador Abelardo Bueno, 600</p>
                                    </div>
                        ...
                        <div class="carousel-inner">
                            <div class="active item carousel-item" data-slide-number="0">
                                <img src="img\empreendimentos\Soho-destaques\soho1.jpg" class="img-fluid" alt="slider-properties">
                            </div>
                            <div class="item carousel-item" data-slide-number="1">
                                <img src="img\empreendimentos\Soho-destaques\soho2.jpg" class="img-fluid" alt="slider-properties">
                            </div>
                            <div class="item carousel-item" data-slide-number="2">
                                <img src="img\empreendimentos\Soho-destaques\soho3.jpg" class="img-fluid" alt="slider-properties">
                            </div>
                            <div class="item carousel-item" data-slide-number="4">
                                <img src="img\empreendimentos\Soho-destaques\soho5.jpeg" class="img-fluid" alt="slider-properties">
                            </div>
                            <div class="item carousel-item" data-slide-number="5">
                                <img src="img\empreendimentos\Soho-destaques\soho4.jpg" class="img-fluid" alt="slider-properties">
                            </div>
                        ...
                        <ul class="carousel-indicators smail-properties list-inline nav nav-justified">
                            <li class="list-inline-item active">
                                <a id="carousel-selector-0" class="selected" data-slide-to="0" data-target="#propertiesDetailsSlider">
                                    <img src="img\empreendimentos\Soho-destaques\soho1.jpg" class="img-fluid" alt="properties-small">
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a id="carousel-selector-1" data-slide-to="1" data-target="#propertiesDetailsSlider">
                                    <img src="img\empreendimentos\Soho-destaques\soho2.jpg" class="img-fluid" alt="properties-small">
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a id="carousel-selector-2" data-slide-to="2" data-target="#propertiesDetailsSlider">
                                    <img src="img\empreendimentos\Soho-destaques\soho3.jpg" class="img-fluid" alt="properties-small">
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a id="carousel-selector-3" data-slide-to="3" data-target="#propertiesDetailsSlider">
                                    <img src="img\empreendimentos\Soho-destaques\soho5.jpeg" class="img-fluid" alt="properties-small">
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a id="carousel-selector-4" data-slide-to="4" data-target="#propertiesDetailsSlider">
                                    <img src="img\empreendimentos\Soho-destaques\soho4.jpg" class="img-fluid" alt="properties-small">
                                </a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="tab-content" id="carTabContent">
                            <div class="tab-pane fade active show" id="one" role="tabpanel" aria-labelledby="one-tab">
                                <div class="properties-description mb-50">
                                    ...
                                    <p>O Soho Residence possui uma grande diversidade de ambientes internos e externos </p>

                                    <p>1,2 e 3 quartos suítes, divididos em 2 edifícios com 582 apartamentos, com 18 pavimentos residenciais e 1 subsolo. São 794 vagas com mais 117 para visitantes. 
                                        </p>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="two" role="tabpanel" aria-labelledby="two-tab">
                                <div class="floor-plans mb-50">
                                    ...
                                    <img src="img\empreendimentos\Soho-destaques\plant.jpg" alt="floor-plans" class="img-fluid">
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade " id="4" role="tabpanel" aria-labelledby="4-tab">
                                <div class="inside-properties mb-50">
                                    ...
                                    <iframe src="https://www.youtube.com/embed/n1MdwDab7kU" allowfullscreen=""></iframe>
                                </div>
                            </div>
                ...
                <div class="properties-condition mb-40">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <ul class="condition">
                                        <li>
                                            <i class="flaticon-square"></i>68 a 205 m²
                                        </li>
