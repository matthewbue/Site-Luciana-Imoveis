<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TheGrove.aspx.vb" Inherits="IlhaPura" %>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-8 col-sm-7">
                <div class="list-inline">
                    <a href="tel:+552199575-8892"><i class="fa fa-phone"></i>Fale Conosco: (21)99575-8892</a>
                    ...
                    <div id="propertiesDetailsSlider" class="carousel properties-details-sliders slide mb-40">
                        ...
                        <div class="heading-properties-2">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pull-left">
                                        <h3>The Grove Resort & SPA</h3>
                                        <p><i class="fa fa-map-marker"></i>Grove Resort Ave, Winter Garden, FL 34787, 14501 - Winter Garden</p>
                                    </div>
                        ...
                        <div class="carousel-inner">
                            <div class="active item carousel-item" data-slide-number="0">
                                <img src="img\empreendimentos\TheGrove-destaques\1.jpg" class="img-fluid" alt="slider-properties">
                            </div>
                            <div class="item carousel-item" data-slide-number="1">
                                <img src="img\empreendimentos\TheGrove-destaques\2.jpg" class="img-fluid" alt="slider-properties">
                            </div>
                            <div class="item carousel-item" data-slide-number="2">
                                <img src="img\empreendimentos\TheGrove-destaques\3.jpg" class="img-fluid" alt="slider-properties">
                            </div>
                            <div class="item carousel-item" data-slide-number="4">
                                <img src="img\empreendimentos\TheGrove-destaques\4.jpg" class="img-fluid" alt="slider-properties">
                            </div>
                            <div class="item carousel-item" data-slide-number="5">
                                <img src="img\empreendimentos\TheGrove-destaques\5.jpg" class="img-fluid" alt="slider-properties">
                            </div>
                        ...
                        <ul class="carousel-indicators smail-properties list-inline nav nav-justified">
                            <li class="list-inline-item active">
                                <a id="carousel-selector-0" class="selected" data-slide-to="0" data-target="#propertiesDetailsSlider">
                                    <img src="img\empreendimentos\TheGrove-destaques\1.jpg" class="img-fluid" alt="properties-small">
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a id="carousel-selector-1" data-slide-to="1" data-target="#propertiesDetailsSlider">
                                    <img src="img\empreendimentos\TheGrove-destaques\2.jpg" class="img-fluid" alt="properties-small">
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a id="carousel-selector-2" data-slide-to="2" data-target="#propertiesDetailsSlider">
                                    <img src="img\empreendimentos\TheGrove-destaques\3.jpg" class="img-fluid" alt="properties-small">
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a id="carousel-selector-3" data-slide-to="3" data-target="#propertiesDetailsSlider">
                                    <img src="img\empreendimentos\TheGrove-destaques\4.jpg" class="img-fluid" alt="properties-small">
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a id="carousel-selector-4" data-slide-to="4" data-target="#propertiesDetailsSlider">
                                    <img src="img\empreendimentos\TheGrove-destaques\5.jpg" class="img-fluid" alt="properties-small">
                                </a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="tab-content" id="carTabContent">
                            <div class="tab-pane fade active show" id="one" role="tabpanel" aria-labelledby="one-tab">
                                <div class="properties-description mb-50">
                                    ...
                                    <p>The Grove Resort & Spa é um refúgio para aqueles que querem fugir do comum e estão procurando experimentar uma realidade infundida com magia e maravilha </p>

                                    <p>Muito bem localizado, próximo da Disney e vizinho das águas azuis do Lago Austin Reserve - a sua paisagem exuberante serve como um complemento para o ambiente majestoso geral 
                                        </p>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade " id="4" role="tabpanel" aria-labelledby="4-tab">
                                <div class="inside-properties mb-50">
                                    ...
                                    <iframe src="https://www.youtube.com/embed/uPEELGGizmQ" allowfullscreen=""></iframe>
                                </div>
                            </div>
                ...
                <div class="properties-condition mb-40">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <ul class="condition">
                                        <li>
                                            <i class="flaticon-square"></i>125 a 150 m²
                                        </li>
...
<script>
    function LoadMap(propertes) {
        var defaultLat = -28.3604891;
        var defaultLng = -81.6538677;
        var mapOptions = {
        ...
        var myLatlng = new google.maps.LatLng(28.3604891, -81.6538677);
        ...
        (function (marker) {
            google.maps.event.addListener(marker, "click", function (e) {
                infoWindow.setContent("" +
                    ...
                    "<p class='address'>Grove Resort Ave, Winter Garden, FL 34787, 14501 </p>" +
