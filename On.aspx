<%@ Page Language="VB" AutoEventWireup="false" CodeFile="On.aspx.vb" Inherits="IlhaPura" %>
                    ...
                    <div id="propertiesDetailsSlider" class="carousel properties-details-sliders slide mb-40">
                        ...
                        <div class="heading-properties-2">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pull-left">
                                        <h3>On Botafogo</h3>
                                        <p><i class="fa fa-map-marker"></i>Rua Voluntários da Pátria - Botafogo
</p>
                                    </div>
                        ...
                        <div class="carousel-inner">
                            <div class="active item carousel-item" data-slide-number="0">
                                <img src="img\empreendimentos\On-destaques\1.jpg" class="img-fluid" alt="slider-properties">
                            </div>
                            <div class="item carousel-item" data-slide-number="1">
                                <img src="img\empreendimentos\On-destaques\2.jpg" class="img-fluid" alt="slider-properties">
                            </div>
                            <div class="item carousel-item" data-slide-number="2">
                                <img src="img\empreendimentos\On-destaques\3.jpg" class="img-fluid" alt="slider-properties">
                            </div>
                            <div class="item carousel-item" data-slide-number="4">
                                <img src="img\empreendimentos\On-destaques\4.jpg" class="img-fluid" alt="slider-properties">
                            </div>
                            <div class="item carousel-item" data-slide-number="5">
                                <img src="img\empreendimentos\On-destaques\5.jpg" class="img-fluid" alt="slider-properties">
                            </div>
                        ...
                        <ul class="carousel-indicators smail-properties list-inline nav nav-justified">
                            <li class="list-inline-item active">
                                <a id="carousel-selector-0" class="selected" data-slide-to="0" data-target="#propertiesDetailsSlider">
                                    <img src="img\empreendimentos\On-destaques\1.jpg" class="img-fluid" alt="properties-small">
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a id="carousel-selector-1" data-slide-to="1" data-target="#propertiesDetailsSlider">
                                    <img src="img\empreendimentos\On-destaques\2.jpg" class="img-fluid" alt="properties-small">
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a id="carousel-selector-2" data-slide-to="2" data-target="#propertiesDetailsSlider">
                                    <img src="img\empreendimentos\On-destaques\3.jpg" class="img-fluid" alt="properties-small">
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a id="carousel-selector-3" data-slide-to="3" data-target="#propertiesDetailsSlider">
                                    <img src="img\empreendimentos\On-destaques\4.jpg" class="img-fluid" alt="properties-small">
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a id="carousel-selector-4" data-slide-to="4" data-target="#propertiesDetailsSlider">
                                    <img src="img\empreendimentos\On-destaques\5.jpg" class="img-fluid" alt="properties-small">
                                </a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="tab-content" id="carTabContent">
                            <div class="tab-pane fade active show" id="one" role="tabpanel" aria-labelledby="one-tab">
                                <div class="properties-description mb-50">
                                    ...
                                    <p>Ser ON é aproveitar o melhor da sua casa, família e amigos </p>

                                    <p>É viver em 1.400m² de lazer com modernidade, personalidade e estilo. É encontrar cores vibrantes, linhas retas e limpas em sofisticados apartamentos e gardens de 2 e 3 quartos de 90 a 249m² e coberturas duplex de 2 a 4 quartos de 178 a 239m². 
                                        </p>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade " id="4" role="tabpanel" aria-labelledby="4-tab">
                                <div class="inside-properties mb-50">
                                    ...
                                    <iframe src="https://www.youtube.com/embed/5Y1zm5hrHdU" allowfullscreen=""></iframe>
                                </div>
                            </div>
                ...
                <div class="properties-condition mb-40">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <ul class="condition">
                                        <li>
                                            <i class="flaticon-furniture"></i>2,3 e 4  Quartos
                                        </li>
                                        <li>
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <ul class="condition">
                                        <li>
                                            <i class="flaticon-square"></i>88 a 250 m²
                                        </li>
