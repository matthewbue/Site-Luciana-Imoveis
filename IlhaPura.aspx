<%@ Page Language="VB" AutoEventWireup="false" CodeFile="IlhaPura.aspx.vb" Inherits="IlhaPura" %>
                    ...
                    <div id="propertiesDetailsSlider" class="carousel properties-details-sliders slide mb-40">
                        ...
                        <div class="heading-properties-2">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pull-left">
                                        <h3>Ilha Pura</h3>
                                        <p><i class="fa fa-map-marker"></i> Avenida Salvador Allende, 3200 - Recreio dos Bandeirantes</p>
                                    </div>
                        ...
                        <div class="carousel-inner">
                            <div class="active item carousel-item" data-slide-number="0">
                                <img src="img\\empreendimentos\Ilha-slide\ilha1.jpg" class="img-fluid" alt="slider-properties">
                            </div>
                            <div class="item carousel-item" data-slide-number="1">
                                <img src="img\\empreendimentos\Ilha-slide\ilha2.jpg" class="img-fluid" alt="slider-properties">
                            </div>
                            <div class="item carousel-item" data-slide-number="2">
                                <img src="img\\empreendimentos\Ilha-slide\ilha3.jpg" class="img-fluid" alt="slider-properties">
                            </div>
                            <div class="item carousel-item" data-slide-number="4">
                                <img src="img\\empreendimentos\Ilha-slide\ilha4.jpg" class="img-fluid" alt="slider-properties">
                            </div>
                            <div class="item carousel-item" data-slide-number="5">
                                <img src="img\\empreendimentos\Ilha-slide\ilha6.jpg" class="img-fluid" alt="slider-properties">
                            </div>
                        ...
                        <ul class="carousel-indicators smail-properties list-inline nav nav-justified">
                            <li class="list-inline-item active">
                                <a id="carousel-selector-0" class="selected" data-slide-to="0" data-target="#propertiesDetailsSlider">
                                    <img src="img\\empreendimentos\Ilha-slide\ilha1.jpg" class="img-fluid" alt="properties-small">
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a id="carousel-selector-1" data-slide-to="1" data-target="#propertiesDetailsSlider">
                                    <img src="img\\empreendimentos\Ilha-slide\ilha2.jpg" class="img-fluid" alt="properties-small">
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a id="carousel-selector-2" data-slide-to="2" data-target="#propertiesDetailsSlider">
                                    <img src="img\\empreendimentos\Ilha-slide\ilha3.jpg" class="img-fluid" alt="properties-small">
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a id="carousel-selector-3" data-slide-to="3" data-target="#propertiesDetailsSlider">
                                    <img src="img\\empreendimentos\Ilha-slide\ilha4.jpg" class="img-fluid" alt="properties-small">
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a id="carousel-selector-4" data-slide-to="4" data-target="#propertiesDetailsSlider">
                                    <img src="img\\empreendimentos\Ilha-slide\ilha6.jpg" class="img-fluid" alt="properties-small">
                                </a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="tab-content" id="carTabContent">
                            <div class="tab-pane fade active show" id="one" role="tabpanel" aria-labelledby="one-tab">
                                <div class="properties-description mb-50">
                                    ...
                                    <p>O Parque da Pedra Branca de um lado e as lagoas da Barra da Tijuca do outro. </p>

                                    <p>No meio desse cartão postal está Ilha Pura. Um bairro planejado com modernas tendências urbanísticas e condomínios de alto padrão. Sustentabilidade, segurança, espaços de lazer e integração com a natureza em um só lugar.
                            ...
                            <div class="tab-pane fade" id="two" role="tabpanel" aria-labelledby="two-tab">
                                <div class="floor-plans mb-50">
                                    ...
                                    <img src="img\empreendimentos\Ilha-slide\plant.jpg" alt="floor-plans" class="img-fluid">
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade " id="4" role="tabpanel" aria-labelledby="4-tab">
                                <div class="inside-properties mb-50">
                                    ...
                                    <iframe src="https://www.youtube.com/embed/UBOy1w3iYAE" allowfullscreen=""></iframe>
                                </div>
                            </div>
                ...
                <div class="properties-condition mb-40">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <ul class="condition">
                                        <li>
                                            <i class="flaticon-square"></i>57 a 143 m²
                                        </li>
