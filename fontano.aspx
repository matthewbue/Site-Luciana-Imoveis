<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fontano.aspx.vb" Inherits="IlhaPura" %>
                    ...
                    <div id="propertiesDetailsSlider" class="carousel properties-details-sliders slide mb-40">
                        ...
                        <div class="heading-properties-2">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pull-left">
                                        <h3>Fontano Residencial</h3>
                                        <p><i class="fa fa-map-marker"></i>R. Leonardo Vilas Boas - Jacarepaguá</p>
                                    </div>
                        ...
                        <div class="carousel-inner">
                            <div class="active item carousel-item" data-slide-number="0">
                                <img src="img\empreendimentos\Fontano\1.jpg" class="img-fluid" alt="slider-properties">
                            </div>
                            <div class="item carousel-item" data-slide-number="1">
                                <img src="img\empreendimentos\Fontano\2.jpg" class="img-fluid" alt="slider-properties">
                            </div>
                            <div class="item carousel-item" data-slide-number="2">
                                <img src="img\empreendimentos\Fontano\3.jpg" class="img-fluid" alt="slider-properties">
                            </div>
                            <div class="item carousel-item" data-slide-number="4">
                                <img src="img\empreendimentos\Fontano\4.jpg" class="img-fluid" alt="slider-properties">
                            </div>
                            <div class="item carousel-item" data-slide-number="5">
                                <img src="img\empreendimentos\Fontano\5.jpg" class="img-fluid" alt="slider-properties">
                            </div>
                        ...
                        <ul class="carousel-indicators smail-properties list-inline nav nav-justified">
                            <li class="list-inline-item active">
                                <a id="carousel-selector-0" class="selected" data-slide-to="0" data-target="#propertiesDetailsSlider">
                                    <img src="img\empreendimentos\Fontano\1.jpg" class="img-fluid" alt="properties-small">
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a id="carousel-selector-1" data-slide-to="1" data-target="#propertiesDetailsSlider">
                                    <img src="img\empreendimentos\Fontano\2.jpg" class="img-fluid" alt="properties-small">
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a id="carousel-selector-2" data-slide-to="2" data-target="#propertiesDetailsSlider">
                                    <img src="img\empreendimentos\Fontano\3.jpg" class="img-fluid" alt="properties-small">
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a id="carousel-selector-3" data-slide-to="3" data-target="#propertiesDetailsSlider">
                                    <img src="img\empreendimentos\Fontano\4.jpg" class="img-fluid" alt="properties-small">
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a id="carousel-selector-4" data-slide-to="5" data-target="#propertiesDetailsSlider">
                                    <img src="img\empreendimentos\Fontano\5.jpg" class="img-fluid" alt="properties-small">
                                </a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="tab-content" id="carTabContent">
                            <div class="tab-pane fade active show" id="one" role="tabpanel" aria-labelledby="one-tab">
                                <div class="properties-description mb-50">
                                    ...
                                    <p>No meio do encontro entre o verde e o mar, você vive momentos únicos </p>

                                    <p>Sinta o piso de porcelanato da sala, decore os quartos aprecia a vista da sua varanda dentro do edifício único. São aptos de 2 e 3 quartos com 67m² a 143m² para você viver em um espaço só seu.  
                                        </p>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="two" role="tabpanel" aria-labelledby="two-tab">
                                <div class="floor-plans mb-50">
                                    ...
                                    <img src="img\empreendimentos\Fontano\plant.jpg" alt="floor-plans" class="img-fluid">
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade " id="4" role="tabpanel" aria-labelledby="4-tab">
                                <div class="inside-properties mb-50">
                                    ...
                                    <iframe src="https://www.youtube.com/embed/7k2YEOtf8cw" allowfullscreen=""></iframe>
                                </div>
                            </div>
                ...
                <div class="properties-condition mb-40">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <ul class="condition">
                                        <li>
                                            <i class="flaticon-square"></i>67 a 143 m²
                                        </li>
                            ...
                            <div class="widget search-area d-none d-xl-block d-lg-block">
                              ...
                              <div class=" widget-2 bg-grea-2 d-lg-none d-xl-none">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="form-group">(21)99575-8892
...
<footer class="footer">
    <div class="container footer-inner">
        ...
        <div class="row">
            <div class="col-xl-12">
                <p class="copy">© 2017 <a href="#">>Luciana Imóveis.</a> Todos os direitos reservados.</p>
            </div>
        </div>
    </div>
</footer>
...
<script>
    function LoadMap(propertes) {
        var defaultLat = -22.9898902;
        var defaultLng = -43.4206544;
        var mapOptions = {
        ...
        var myLatlng = new google.maps.LatLng(-22.9898902, -43.4206544);
